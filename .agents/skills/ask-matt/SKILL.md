---
name: ask-matt
description: Use at the start of any non-trivial engineering task (feature, refactor, bug, design/UX decision) to route to the right skill or flow — a router over the skills in this repo. Also use when asked which skill or flow fits a situation. Skip for commits, PRs, single lookups, tiny fixes, and follow-up turns of a flow already in progress.
---
